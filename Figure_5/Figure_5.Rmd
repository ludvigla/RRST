...
# Mouse brain
samples <- Sys.glob(paths = "../../spaceranger_output/pediatricbraintumor/*/filtered_feature_bc_matrix.h5")
imgs <- Sys.glob(paths = "../../spaceranger_output/pediatricbraintumor/*/spatial/tissue_hires_image.png")
spotfiles <- Sys.glob(paths = "../../spaceranger_output/pediatricbraintumor/*/spatial/tissue_positions_list.csv")
json <- Sys.glob(paths = "../../spaceranger_output/pediatricbraintumor/*/spatial/scalefactors_json.json")
...
annotations <- Sys.glob(paths = "../../spaceranger_output/pediatricbraintumor/*/Pathology*")
