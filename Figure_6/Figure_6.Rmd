...
samples <- list.files(path = "../../spaceranger_output/mousebone", pattern = "filtered", recursive = TRUE, full.names = TRUE)
imgs <- list.files(path = "../../spaceranger_output/mousebone", pattern = "tissue_hires_image.png", recursive = TRUE, full.names = TRUE)
spotfiles <- list.files(path = "../../spaceranger_output/mousebone", pattern = "tissue_positions_list.csv", recursive = TRUE, full.names = TRUE)
json <- list.files(path = "../../spaceranger_output/mousebone", pattern = "scalefactors_json.json", recursive = TRUE, full.names = TRUE)
...
p_violin <- ggplot() + 
  geom_violin(data = se[[]], aes(arrayID, nFeature_RNA, fill = protocol), scale = "width") +
...
pdf(file = "violin_QC.pdf", width = 5.5, height = 8)
print(p_violin)
dev.off()
